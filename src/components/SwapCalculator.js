    ...
    function convertFiatToCrypto() {
        ...
        fetch(url)
            ...
            .then(data => {
                ...
                document.getElementById("currency-result").value = convertedAmount.toFixed(8) +` ${crypto.toUpperCase()}`;
            })
    ...
    <div className='mainMenu'>
        <div className="calculator-container">
            <div class="select-crypto">
                <label for="crypto">Select your fiat currency</label>
                <select onChange={convertFiatToCrypto} name="fiat" id="fiat" class="input-field">
            ...
            <div class="enter-amount">
                ...
                <input onChange={convertFiatToCrypto} type="text" placeholder="BTC" id="crypto-amount" class="input-field"/>
            </div>
            <div class="select-fiat">
                <label for="fiat">Select your crypto</label>
                <select onChange={convertFiatToCrypto} name="cryptocurrencies" id="crypto" class="input-field">
            ...
            <div class="result">
                <label for="currency-result" class="result-label">Crypto amount</label>
                <input type="text" placeholder="BTC" id="currency-result" class="input-field"/>
            </div>
